...
The objective was to build a machine learning that predicts whether a loan will be defaulted
This model would be used in a bank's approval process and flag high risk applications before loan is approved
  It was crucial that we ensured that the information used in the model would be accurate.
